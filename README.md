...
order book, OHLCV aggregation, **677+ streaming technical indicators**, position ledger,
...
| [`signals`] | `Signal` trait, `SignalPipeline`, **677+ built-in indicators**, `SignalMap` (90+ methods) | Returns `Unavailable` until warm-up period is satisfied; no silent NaN |
