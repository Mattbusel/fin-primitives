...
| [`signals`] | `Signal` trait, `SignalPipeline`, **579+ built-in indicators**, `SignalMap` (90+ methods) | Returns `Unavailable` until warm-up period is satisfied; no silent NaN |
